Public Class frmsupplierbill
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        ...
        txtrat.DataBindings.Clear()
        txtrat.Text = ""
        txtrat.ReadOnly = False
    ...
    Private Sub cmdUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUpdate.Click
        ...
        If (cmdUpdate.Tag = "S") Then
            ...
            sqlText = "INSERT INTO customer_bill (bill_no,customer_name,product_name,qty,rate,amt)" & _
                        "VALUES('" & txtSerialNo.Text & "','" & _
                        Trim(cboDepartment.Text) & "','" & Trim(txtproductname.Text) & _
                        "'," & Val(txtqty.Text) & "," & Val(txtrat.Text) & "," & Val(txtamt.Text) & ")"
        Else
            sqlText = "UPDATE customer_bill  SET customer_name='" & Trim("" & cboDepartment.Text) & "'," & _
                        "product_name='" & Trim("" & txtproductname.Text) & "',qty=" & Val(txtqty.Text) & ",rate=" & Val(txtrat.Text) & ",amt=" & Val(txtamt.Text) & " WHERE bill_no='" & txtSerialNo.Text & "'"
    ...
    Private Sub processBind()
        ...
        If dtTemp.Rows.Count > 0 Then
            ...
            txtproductname.DataBindings.Clear()
            txtproductname.DataBindings.Add("Text", dtTemp, "product_name")
            txtqty.DataBindings.Clear()
            txtqty.DataBindings.Add("Text", dtTemp, "qty")

            txtrat.DataBindings.Clear()
            txtrat.DataBindings.Add("Text", dtTemp, "rate")

            txtamt.DataBindings.Clear()
            txtamt.DataBindings.Add("Text", dtTemp, "amt")
